...
# CUDA_VISIBLE_DEVICES=0 python get_activations.py llama3_8B tqa_mc2 --device 0
# CUDA_VISIBLE_DEVICES=0 python get_activations.py llama3_8B tqa_gen_end_q --device 0
